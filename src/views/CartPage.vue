    ...
    <section class="cart">
      <form action="#" class="cart__form form" method="POST">
        <div class="cart__field">
          <!-- TODO: Разбить список в корзине на компоненты -->
          <ul class="cart__list">
            <li
              ...
              <span class="product__code">
                ...
                <!-- TODO: реализовать изменение кол-ва товара в корзине через стейт  -->
              ...
              <!-- TODO: реализовать удаление товара из корзины через стейт -->
              <button
